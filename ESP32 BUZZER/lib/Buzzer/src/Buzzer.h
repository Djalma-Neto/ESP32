...
void asaBranca(int buzzer, int button) {
    int tempo = 120;
...
void gameOfThrones(int buzzer, int button){
    int tempo = 85;
...
void starWars(int buzzer, int button){
    int tempo = 108;
    int melody[] = {
...
void imperialMarch(int buzzer, int button){
    int tempo = 120;
    int melody[] = {    
...
void harryPotter(int buzzer, int button){
    int tempo = 144;
    int melody[] = {
        REST, 2, NOTE_D4, 4,
...
void Doom(int buzzer, int button){
    int tempo = 225;
...
// -/-
  ...
  NOTE_B3, -16, NOTE_G3, -16, NOTE_E3, -16, NOTE_B2, -16, NOTE_E3, -16, NOTE_G3, -16, NOTE_C4, -16, NOTE_B3, -16, NOTE_G3, -16, NOTE_B3, -16, NOTE_G3, -16, NOTE_E3, -16,  
    ...
    for (int thisNote = 0; thisNote < notes * 2; thisNote = thisNote + 2) {
        ...
        tone(buzzer, pgm_read_word_near(melody+thisNote));
        delay(noteDuration);
        noTone();
    }
}
